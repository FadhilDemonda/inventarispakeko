...
async function seedOctoberData() {
  console.log('🌱 Menyiapkan Seed Data Realistis Bulan Oktober 2026...');
  ...
  try {
    ...
    // 2. Insert Data Barang Kantor (Oktober 2026)
    const barangData = [
      {
    ...
    // 3. Insert Data Kendaraan Dinas (Oktober 2026)
    const kendaraanData = [
      {
        nama: 'Toyota Kijang Innova Reborn 2.4 V',
        plat: 'B 1024 KTR',
        satker: 'Bagian Umum & Rumah Tangga',
        pajak: '2026-11-15', // Akan Habis (~23 hari dari akhir Oktober)
      ...
      },
      {
        ...
        pajak: '2026-10-05', // Expired (lewat awal Oktober)
        peminjam: null,
    ...
    for (const k of kendaraanData) {
      const res = await pool.query(
        `INSERT INTO kendaraan (nama_kendaraan, nomor_plat, satker, tanggal_pajak, keterangan, peminjam, created_at)
         VALUES ($1, $2, $3, $4, $5, $6, '2026-10-01 08:00:00')
    ...
    const transaksiData = [
      ...
      },
      {
        ...
        jumlah: 1,
        pinjam: '2026-10-14 07:00:00',
        kembali: '2026-10-16 19:30:00',
        status: 'Dikembalikan',
    ...
    // 5. Insert Activity Log Kronologis Bulan Oktober 2026
    const logData = [
      {
        action: 'login',
        entity: 'auth',
        detail: 'Admin Gudang (admin@kantor.com) berhasil login ke sistem.',
        time: '2026-10-01 07:45:12'
      },
      {
        action: 'create',
        entity: 'barang',
        detail: 'Menambahkan stok awal inventaris barang periode Triwulan IV 2026.',
        time: '2026-10-01 08:30:00'
      },
      {
        action: 'create',
        entity: 'kendaraan',
      ...
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman barang "Proyektor Epson EB-X500 HD" sebanyak 1 unit oleh Taufik Hidayat (Perencanaan) (No. Surat: 003/PINJAM/RAPAT/X/2026).',
      ...
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman kendaraan "Honda Vario 160 CBS" (B 6128 KTR) oleh Agus Setiawan (Kurir) (No. Surat: 007/SPT/KTR/X/2026).',
      ...
      },
      {
        ...
        time: '2026-10-05 16:30:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman barang "Laptop Lenovo ThinkPad T14 Gen 3" sebanyak 1 unit oleh Danang Wicaksono (Auditor Internal) (No. Surat: 011/PINJAM/IT/X/2026).',
      ...
      },
      {
        ...
        time: '2026-10-12 16:00:00'
      },
      {
        action: 'update',
        entity: 'barang',
        detail: 'Pengecekan kondisi berkala: "Kabel HDMI to VGA Adapter 3M" diubah menjadi Rusak Ringan.',
        time: '2026-10-15 15:00:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman barang "Printer HP LaserJet Pro MFP M428fdn" sebanyak 1 unit oleh Mega Utami (Sekretariat Pimpinan) (No. Surat: 032/PINJAM/SEK/X/2026).',
        time: '2026-10-18 09:00:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman barang "Laptop Lenovo ThinkPad T14 Gen 3" sebanyak 3 unit oleh Fadlan Ramadhan (Tim IT Support) (No. Surat: 019/PINJAM/IT/X/2026). Sisa stok: 9.',
        time: '2026-10-20 10:00:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman barang "Laptop Dell Latitude 5420" sebanyak 2 unit oleh Siti Nurhaliza (Pusdiklat) (No. Surat: 022/PINJAM/DIK/X/2026). Sisa stok: 6.',
        time: '2026-10-22 08:45:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman barang "Kabel Roll Terminal 15 Meter" sebanyak 2 unit oleh Eko Prasetyo (Teknisi Gedung) (No. Surat: 030/PINJAM/OPER/X/2026). Sisa stok: 8.',
        time: '2026-10-23 11:00:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman kendaraan "Toyota Kijang Innova Reborn 2.4 V" (B 1024 KTR) oleh Dr. Hendra Gunawan, S.E., M.M. (Kabag Umum) (No. Surat: 028/SPT/UMUM/X/2026).',
        time: '2026-10-24 07:30:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman barang "Proyektor Epson EB-X500 HD" sebanyak 1 unit oleh Bambang Sudiro (Bagian Keuangan) (No. Surat: 025/PINJAM/RAPAT/X/2026). Sisa stok: 4.',
        time: '2026-10-24 13:00:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman kendaraan "Toyota Avanza 1.3 G M/T" (B 1455 KTR) oleh Rian Kurniawan (Tim Protokol) (No. Surat: 031/SPT/PROT/X/2026).',
        time: '2026-10-25 08:15:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman barang "Kamera Sony Alpha A7 III (Dokumentasi)" sebanyak 1 unit oleh Dimas Prasetyo (Humas & Dokumentasi) (No. Surat: 027/PINJAM/HUMAS/X/2026). Sisa stok: 2.',
        time: '2026-10-25 09:30:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman barang "Sound Portable Wireless Speaker (Mic Set)" sebanyak 1 unit oleh Anisa Rahmawati (Panitia HUT Kantor) (No. Surat: 029/PINJAM/ACARA/X/2026). Sisa stok: 1.',
        time: '2026-10-25 14:00:00'
      },
      {
        action: 'pinjam',
        entity: 'transaksi',
        detail: 'Peminjaman kendaraan "Suzuki Carry Pickup Wide Deck" (B 9210 KTR) oleh Wahyu Hidayat (Staf Logistik Gudang) (No. Surat: 033/LOG/GUDANG/X/2026).',
        time: '2026-10-26 09:00:00'
      }
    ];
    ...
    console.log('🎉 Data Bulan Oktober 2026 Berhasil Dikonfigurasi!');
    process.exit(0);
  } catch (error) {
